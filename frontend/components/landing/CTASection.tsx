...
export default function CTASection() {
  ...
  return (
    <section className="relative py-24 overflow-hidden">
      {/* ============================================
          LIGHT MODE - YOUR ORIGINAL DESIGN (UNCHANGED)
          ============================================ */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:hidden"></div>
      <div className="absolute inset-0 opacity-30 dark:opacity-0" style={{
        backgroundImage: "radial-gradient(circle, #000 1px, transparent 1px)",
        backgroundSize: "24px 24px"
      }}></div>
      
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* LIGHT MODE CARD - YOUR ORIGINAL, PERFECTLY INTACT */}
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 md:p-12 border border-white/50 dark:hidden">
        ...
        {/* ============================================
            DARK MODE - COMPLETELY SEPARATE, VISIBLE
            ============================================ */}
        <div className="hidden dark:block">
          {/* Dark mode background */}
          <div className="absolute inset-0 bg-gray-900 -z-10 rounded-2xl"></div>
